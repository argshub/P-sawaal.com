...
$mysql->query("create table if not exists sawaal_questions (id int auto_increment primary key, questionLabel text unique, questionUri text, questionTitle longtext,questionTags text,questionExplanation longtext )");
